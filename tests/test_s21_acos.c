...
Suite *suite_s21_acos(void) {
    ...
    tcase_add_loop_test(tc, acos_test_2_rand, 0, 10000);
    tcase_add_loop_test(tc, acos_test_3_rand, 0, 10000);
    tcase_add_loop_test(tc, acos_test_4_rand, 0, 10000);
    tcase_add_loop_test(tc, acos_test_5_rand, 0, 10000);
